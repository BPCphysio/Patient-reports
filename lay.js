...
window.LAY = (function () {
  ...
  const MOVE = [
    ...
    [["bend forward", "bending forward", "bending down", "bend down", "touch the floor", "touch your toes", "reach for your toes", "bend down to the floor", "fold forward", "roll down"], "Trunk flexion"],
    [["lean back", "bending back", "bend back", "bending backward", "back extension", "lean backwards", "lean back with your hands on your hips", "arch your back", "bend backwards", "look up and lean back", "extend your back"], "Trunk extension"],
    [["slide your hand down your leg", "slide your hand down the side of your leg", "hand down the side of your leg", "lean to the side", "side bending", "bending your body to", "bending body to", "side bend", "tip to the side", "reach down the side of your leg", "slide your hand down"], "Trunk lateral flexion"],
    [["twist your body", "twist round", "turning your body", "turn into the", "turn your body", "rotate your trunk", "look behind you with your whole body"], "Trunk rotation"],
  ...
  const TESTS = [
    ...
    [["figure four", "figure of four", "faber", "ankle on the other knee", "ankle across your other knee and let the knee drop", "like a number four"], "FABER", [R_HIP, R_LUMB]],
  ...
  const DX = [
    ...
    [["sacroiliac joint", "si joint dysfunction", "si joint is", "si joint problem", "joint at the back of your pelvis", "the joint where your spine meets your pelvis"], "Sacroiliac joint dysfunction", [R_LUMB, R_HIP]],
